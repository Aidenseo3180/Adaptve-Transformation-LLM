...
def run_from_config():
    """Run VLM distance profiling from configuration file."""
    parser = argparse.ArgumentParser(
        description="Run VLM distance analysis with token-type separation from config file."
    )
    parser.add_argument(
        "--config",
        type=str,
